...
`),w=(t,{id:s,defaultConfig:e,defaultPalette:n,generator:r,userConfig:f,userPalette:p})=>t.writeTemp(`sass-palette/${s}-config.scss`,`@import "file:///${d(n)}";
@import "file:///${d(e)}";
@import "file:///${d(p)}";
@import "file:///${d(f)}";
@import "file:///${d(r)}";
...
`):Promise.resolve(null),v=D(import.meta.url),I=t=>s=>{s.env.isDebug&&m.info("Options:",t);const{id:e="hope",config:n=`.vuepress/styles/${e}-config.scss`,defaultConfig:r=$.resolve(v,"../../styles/default/config.scss"),palette:f=`.vuepress/styles/${e}-palette.scss`,defaultPalette:p=$.resolve(v,"../../styles/default/palette.scss"),generator:i=$.resolve(v,"../../styles/empty.scss"),style:l=""}=t,u=s.dir.source(n),o=s.dir.source(f),c=l?s.dir.source(l):null;return{name:"vuepress-plugin-sass-palette",multiple:!0,id:e,alias:{["@sass-palette/helper"]:$.resolve(v,"../../styles/helper.scss"),[`@sass-palette/${e}-config`]:s.dir.temp(`sass-palette/${e}-config.scss`),[`@sass-palette/${e}-inject`]:s.dir.temp(`sass-palette/${e}-inject.scss`),[`@sass-palette/${e}-palette`]:s.dir.temp(`sass-palette/${e}-palette.scss`),...l?{[`@sass-palette/${e}-style`]:s.dir.temp(`sass-palette/${e}-style.scss`)}:{}},extendsBundlerOptions:(a,g)=>{E(a,g,e)},onInitialized:()=>Promise.all([z(s,e),w(s,{id:e,defaultConfig:r,defaultPalette:p,generator:i,userConfig:u,userPalette:o}),j(s,{id:e,defaultPalette:p,generator:i,userPalette:o}),x(s,{id:e,userStyle:c})]).then(()=>{s.env.isDebug&&m.info(`Style file for ${e} generated`)}),onWatched:(a,g)=>{const y=b(u,{cwd:a.dir.source(),ignoreInitial:!0}),C=()=>w(a,{id:e,defaultConfig:r,defaultPalette:p,generator:i,userConfig:u,userPalette:o}).then(()=>{a.env.isDebug&&m.info(`Style file for ${e} updated`)});y.on("add",()=>{C()}),y.on("unlink",()=>{C()}),g.push(y);const h=b(o,{cwd:a.dir.source(),ignoreInitial:!0}),S=()=>Promise.all([w(a,{id:e,defaultConfig:r,defaultPalette:p,generator:i,userConfig:u,userPalette:o}),j(a,{id:e,defaultPalette:p,generator:i,userPalette:o})]).then(()=>{a.env.isDebug&&m.info(`Style file for ${e} updated`)});if(h.on("add",()=>{S()}),h.on("unlink",()=>{S()}),g.push(h),c){const P=b(c,{cwd:a.dir.source(),ignoreInitial:!0}),k=()=>x(a,{id:e,userStyle:c}).then(()=>{a.env.isDebug&&m.info(`Style file for ${e} updated`)});P.on("add",()=>{k()}),P.on("unlink",()=>{k()}),g.push(P)}},clientConfigFile:a=>R(a,e)}},B=(t,s)=>{t.pluginApi.plugins.filter(e=>e.name==="vuepress-plugin-sass-palette").every(e=>e.id!==s.id)&&t.use(I(s))},L=(t,s)=>{const e=t.pluginApi.plugins.filter(n=>n.name==="vuepress-plugin-sass-palette").findIndex(n=>n.id===s);e!==-1&&t.pluginApi.plugins.splice(e,1)};export{L as removePalettePlugin,I as sassPalettePlugin,B as useSassPalettePlugin};

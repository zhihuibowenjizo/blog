...
export const usePlugin = (app, plugins, legacy, hotReload) => {
    // respect git options
    if ("git" in plugins)
        useGitPlugin(app, "git" in plugins
            ? plugins.git === true
                ? {
                    createdTime: true,
                    contributors: true,
    ...
    if (plugins.readingTime !== false)
        useReadingTimePlugin(app, typeof plugins.readingTime === "object" ? plugins.readingTime : {});
